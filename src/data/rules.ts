...
export const rules: Rule[] = [
    ...
    { id: 2, color: Colors.White, text: "Turns gray, flips adjacent tiles white/gray" },
    ...
    { id: 6, color: Colors.Orange, text: "Changes to the dominant color among adjacent tiles" },
